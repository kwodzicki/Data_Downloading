...
save_dir  = save_dir+'6H_1000-850hPa_'+grid_int+'/'       #Save dir

area      = '90/0/-90/360'                                #Set the domain to use
variables = '130/131/132/155/157'                         #Set variables to get
levels    = '1000/925/850'                                #Set levels to get

#Set date arrays for iteration
year = [1997]                                             #Initialize year
month= [12]                                               #Initialize month

for i in range(1998,2013):                                #Iterate over years
...
for date in range(len(year)):
	...
	filename = save_dir+'Interim_'+str(cur_year)+mm+'.nc'
