...
def era_interim_download_fc_sfc(dir, start_year = None, start_month = None, email = None):
	if start_year  is None: start_year  = 1979;
	if start_month is None: start_month = 1;
	
	subject = 'ERA-Interim an_sfc FAILED!';
	out_dir = os.path.join(dir, 'Forecast', 'Surface');
	...
	vars  = [  44.128,  45.128,  49.128,  50.128, 142.128, 143.128, 144.128, \
            ...
            240.128, 243.128, 244.128];																										# List of analysis pressure level variables to download
